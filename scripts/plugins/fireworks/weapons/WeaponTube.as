...
class FireworkWeaponTube : BaseWeaponLayer, BaseWeapon
{
	...
	bool Deploy()
	{
		return Deploy("models/fireworks/v_tube.mdl", "models/fireworks/p_tube.mdl", FW_WEP_DRAW, "hive", animDrawTime);
	}
